...
const DeleteConfirmationModal: React.FC<DeleteModalProps> = ({ isOpen, onClose, onConfirm, refImpaye }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6 transform transition-all">
        ...
        {/* Message personnalisé et épuré */}
        <p className="text-gray-600 my-4">
          Souhaitez-vous supprimer l'incident <span className="font-semibold text-gray-800">{refImpaye}</span> ?
        </p>
